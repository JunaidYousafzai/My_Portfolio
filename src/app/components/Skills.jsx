...
const skills = [
  ...
  { name: "Next.js", icon: <SiNextdotjs className="k w-14 h-14" /> },
...
const Skills = () => {
  ...
  return (
    <section ref={sectionRef} className="text-center">
      <h2 className="text-4xl font-[Reospec]  text-teal-600 font-bold my-[2%] ">My Tech Stack</h2>
      ...
      <div className="my-12">
        <h3 className="text-3xl font-[Reospec] text-teal-600   font-semibold my-[2%]">Currently Learning</h3>
